...
# Load models
class_model = load_pickle(os.path.join(BASE_DIR, "models", "best_model_class.pkl"))
reg_model = load_pickle(os.path.join(BASE_DIR, "models", "best_model_reg.pkl"))
clust_model = load_pickle(os.path.join(BASE_DIR, "models", "best_model_cluster.pkl"))
preprocessor = load_pickle(os.path.join(BASE_DIR, "models", "preprocessed_data.pkl"))
